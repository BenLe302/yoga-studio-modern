...
const Register = () => {
  ...
  const { setIsAuthenticated, setUser, addNotification } = useStore();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (formData.password !== formData.confirmPassword) {
      addNotification(t('auth.passwordMismatch'), 'error');
      return;
    }
    ...
    if (formData.name && formData.email && formData.password) {
      ...
      addNotification(t('auth.registerError'), 'error');
    }
  };
